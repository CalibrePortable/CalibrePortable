package org.geeklub.smartlib.module.common.login;
...
import org.geeklub.smartlib.module.common.login.presenter.LoginPresenter;
import org.geeklub.smartlib.module.common.login.presenter.LoginPresenterImpl;
import org.geeklub.smartlib.module.common.login.view.LoginView;
import org.geeklub.smartlib.module.common.register.RegisterActivity;
import org.geeklub.smartlib.module.user.NormalUserMainActivity;
...
public class LoginActivity extends ActionBarActivity implements LoginView, View.OnClickListener {
  ...
  public void navigateToMain() {
    startActivity(new Intent(this, NormalUserMainActivity.class));
  }
