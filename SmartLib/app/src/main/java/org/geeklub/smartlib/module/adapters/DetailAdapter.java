...
public class DetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  public static class ViewHolderHeader extends RecyclerView.ViewHolder {
    ...
    @InjectView(R.id.tv_book_publisher) TextView mBookPublisher;
  ...
  public static class ViewHolderItem extends RecyclerView.ViewHolder {
    @InjectView(R.id.tv_book_id) TextView mBookId;
    @InjectView(R.id.tv_created_at) TextView mCreatedAt;
    @InjectView(R.id.tv_return_at) TextView mReturnAt;
    @InjectView(R.id.tv_user_name) TextView mUserName;
  ...
  @Override public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
    switch (getItemViewType(position)) {
      case VIEW_TYPE_HEADER:
        ...
        viewHolderHeader.mBookPublisher.setText("出版社:" + bookDetailInfo.book_detail.book_pub);
